         ...
         <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    {{-- <img src="{{asset('image/')}}/{{ $menu->image }}" width="100px"> --}}
                    @if ($menu->image)
                        <img src="{{asset('image/')}}/{{ $menu->image }}" alt="{{ $menu->name }}" class="img-thumbnail" width="150px">
                    @endif
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="quantity" value="{{ $menu->quantity }}" class="form-control" placeholder="Quantity">
                </div>
            </div>
